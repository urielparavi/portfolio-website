          ...
          <div className="max-w-4xl mx-auto">
            ...
            <div className="space-y-12">
                ...
                <div className="pr-15 space-y-4">
                  <div className="p-6 rounded-lg bg-muted/50 border">
                    ...
                    <ul className="space-y-2 text-muted-foreground">
                      ...
                      <li>
                        • שימוש בשירותי צד שלישי, לרבות צ’אט AI, כלי ניתוח
                        נתונים או כלים חיצוניים אחרים, נעשה על אחריות המשתמש
                        בלבד
                      </li>
                      <li>
                        • החברה אינה אחראית לנזקים, אובדן מידע או הפרת פרטיות
                        הנובעים משימוש בשירותי צד שלישי
                      </li>
                    </ul>
                  </div>
                  <div className="p-6 rounded-lg bg-muted/50 border">
                    ...
                    <ul className="space-y-2 text-muted-foreground">
                      ...
                      <li>
                        • שירותים כמו צ’אט AI, Google Analytics וכל שירות צד
              ...
              <div className="space-y-4">
                ...
                <div className="pr-15 space-y-3">
                  <p className="text-muted-foreground mb-2">
                    שימוש באתר כרוך בקבלת מדיניות הפרטיות שלנו, הכוללת:
                  </p>
                  <ul className="list-disc pl-5 text-muted-foreground space-y-1">
                    <li>
                      שמירת מידע אישי לצורך מתן שירות, תמיכה וקשר עם המשתמש בלבד
                    </li>
                    <li>
                      שימוש בקוקיז, כלי ניתוח או שירותי צד שלישי, לרבות צ'אט AI,
                      שירותי ניתוח סטטיסטיים וכלים חיצוניים אחרים
                    </li>
                    <li>
                      החברה אינה אחראית לנזקים, אובדן מידע או הפרת פרטיות
                      הנגרמים משימוש בשירותי צד שלישי. כל שימוש בשירותי צד שלישי
                      כפוף לתנאי השימוש והמדיניות שלהם בלבד
                    </li>
                    <li>
                      אין החברה מפיצה מידע אישי לצד שלישי ללא הסכמה, למעט דרישה
                      חוקית או צו בית משפט
                    </li>
                  </ul>
                  <p className="text-sm text-muted-foreground">
                    ⚠️ שימוש בשירותי צד שלישי נעשה על אחריות המשתמש בלבד. החברה
                    אינה נושאת באחריות לתקלות, זמינות, אבטחה או נזקים הנובעים
                    משירותים אלה.
                  </p>
                </div>
              </div>
              ...
              <div className="space-y-4">
                ...
                <div className="pr-15 space-y-3">
                  <ul className="list-disc pl-5 text-muted-foreground space-y-2">
                    <li>תנאי שימוש אלו כפופים לחוקי מדינת ישראל בלבד.</li>
                    <li>
                      כל מחלוקת, דרישה, תביעה או סכסוך הנובע מהשימוש באתר או
                      מהשירותים הניתנים בו, או בקשר עם תנאי שימוש אלו, יובאו
                      להכרעה בפני בתי המשפט המוסמכים בישראל, בהתאם לחוק.
                    </li>
                    <li>
                      אין בכפיפת תנאי שימוש אלו לדין הישראלי כדי לפגוע בזכויותיך
                      המוקנות לפי חוקי הצרכן או כל חוק מחייב אחר.
                    </li>
                    <li>
                      במקרה של סתירה בין הוראות חוק מחייב לבין הוראות תנאי שימוש
                      אלו, יגבר החוק המחייב.
                    </li>
                    <li>
                      כל צד מתחייב לעשות מאמצים סבירים לפתרון סכסוכים באופן
                      ידידותי ובלתי פורמלי לפני פנייה לבית המשפט.
                    </li>
                    <li>
                      במידה ונקבע כי הוראה כלשהי בתנאי שימוש אלו אינה חוקית,
                      בלתי תקפה או בלתי אכיפה על פי דין, ההוראה תיושם במידה
                      המירבית האפשרית והוראות אחרות ימשיכו להיות בתוקף מלא.
                    </li>
                  </ul>
                </div>
              </div>
