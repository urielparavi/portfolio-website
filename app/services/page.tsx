...
export const metadata: Metadata = {
  title: 'השירותים שלי | Weby – אוריאל בניית אתרים',
  description:
    'שירותי בניית אתרים מקצועיים: אתרי נחיתה להמרות, אתרי תדמית עסקיים 5-10 דפים, וחנויות אונליין עם תשלומים. פתרונות מותאמים אישית החל מ-₪1,500.',
  robots: {
    index: true,
    follow: true,
  },
  openGraph: {
    title: 'השירותים שלי | Weby – אוריאל בניית אתרים',
    description:
      'בניית אתרי נחיתה, אתרי תדמית עסקיים וחנויות E-commerce. פתרונות מקצועיים ומותאמים אישית לכל עסק',
    type: 'website',
    locale: 'he_IL',
  },
};
