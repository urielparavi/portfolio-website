...
//           {/* Main carousel card - lighter colors */}
//           <div className="relative p-1 rounded-2xl bg-gradient-to-r from-sky-400 via-blue-400 to-indigo-400 shadow-2xl shadow-blue-400/20 transition-shadow duration-300 hover:shadow-3xl hover:shadow-blue-400/30">
//             <div className="relative aspect-video rounded-xl overflow-hidden bg-card">
//               {/* Badge - lighter blue gradient */}
//               <div className="absolute top-4 left-4 z-10 px-4 py-2 rounded-full bg-gradient-to-r from-sky-400 via-blue-400 to-indigo-400 text-white shadow-xl flex items-center gap-2 text-sm font-bold">
...
//                 {/* Lighter blue gradient overlays */}
//                 <div className="absolute inset-0 bg-gradient-to-t from-black via-black/50 to-transparent opacity-90" />
//                 <div className="absolute inset-0 bg-gradient-to-tr from-sky-500/30 via-blue-500/20 to-indigo-500/30 mix-blend-overlay" />
//                 <div className="absolute inset-0 bg-gradient-to-bl from-transparent via-transparent to-indigo-500/20 mix-blend-overlay" />

//                 {/* Content card */}
//                 <div className="absolute bottom-0 left-0 right-0 p-6 bg-gradient-to-t from-black/95 via-black/70 to-transparent">
//                   <div className="space-y-4">
//                     {/* Title with lighter blue gradient text */}
//                     <h3 className="text-3xl md:text-4xl font-bold bg-gradient-to-r from-sky-300 via-blue-300 to-indigo-300 bg-clip-text text-transparent drop-shadow-2xl">
...
//                     {/* Tech stack - lighter blue variations */}
...
//                               gradients[idx % 3]
//                             } text-white shadow-xl transition-shadow duration-300 hover:shadow-2xl flex items-center gap-2 text-sm font-medium`}
//                           >
...
//           {/* Navigation Buttons - lighter blue gradients */}
//           <Button
//             variant="outline"
//             size="icon"
//             className="absolute left-4 top-1/2 -translate-y-1/2 bg-gradient-to-r from-sky-400 to-blue-400 hover:from-sky-500 hover:to-blue-500 text-white border-0 shadow-2xl shadow-blue-400/30 transition-all duration-300"
//             onClick={nextSlide}
...
//             variant="outline"
//             size="icon"
//             className="absolute right-4 top-1/2 -translate-y-1/2 bg-gradient-to-r from-blue-400 to-indigo-400 hover:from-blue-500 hover:to-indigo-500 text-white border-0 shadow-2xl shadow-indigo-400/30 transition-all duration-300"
//             onClick={prevSlide}
//             disabled={isTransitioning}
...
//                   index === currentIndex
//                     ? 'w-12 bg-gradient-to-r from-sky-400 via-blue-400 to-indigo-400 shadow-lg shadow-blue-400/50'
//                     : 'w-3 bg-muted-foreground/50 hover:w-6 hover:bg-gradient-to-r hover:from-sky-300 hover:to-blue-300'
//                 }`}
...
//           {/* Pause indicator - lighter blue gradient */}
//           {isPaused && (
//             <div className="absolute top-4 right-4 px-4 py-2 bg-gradient-to-r from-sky-400 to-blue-400 text-white rounded-full shadow-xl flex items-center gap-2 text-sm font-bold">
